...
var initResizeObserver = function () {
    if (!observerInitialized) {
        var element_1 = document.getElementsByClassName(App_1.LivoAppContainer)[0];
        var resizeObserver = new ResizeObserver(function (entries) {
            if (entries[0] && entries[0].contentBoxSize[0]) {
                var height = element_1.getBoundingClientRect().height;
        ...
        resizeObserver.observe(element_1);
    }
