...
var useDataFromDataSync = function (attendee) {
    var getMuteState = muteStateHook_1.useMuteState().getMuteState;
    var enableMakeSpeakerButtonDefault = true,
        muteMikeDefault = getMuteState();
    var dataSync = dataSyncHook_1.useDataSync();
    var attendeeDataSync = dataSync[attendee.id];
    if (attendeeDataSync) {
        enableMakeSpeakerButtonDefault = attendeeDataSync.speaker === undefined ? enableMakeSpeakerButtonDefault : !attendeeDataSync.speaker;
        muteMikeDefault = attendeeDataSync.mute === undefined ? muteMikeDefault : attendeeDataSync.mute;
    }
    return { enableMakeSpeakerButtonDefault: enableMakeSpeakerButtonDefault, muteMikeDefault: muteMikeDefault };
};
var Attendee = function (_a) {
    ...
    var _c = useDataFromDataSync(attendee),
        enableMakeSpeakerButtonDefault = _c.enableMakeSpeakerButtonDefault,
        muteMikeDefault = _c.muteMikeDefault;
    var _d = react_1.useState(enableMakeSpeakerButtonDefault),
        isMakeSpeakerButtonEnabled = _d[0],
        enableMakeSpeakerButton = _d[1];
