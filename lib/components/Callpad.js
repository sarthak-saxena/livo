...
var muteStateHook_1 = require("../services/hooks/muteStateHook");
...
var useOnMuteAttendeeCallback = function (muteMike) {
    ...
    var setMuteState = muteStateHook_1.useMuteState().setMuteState;
    return react_1.default.useCallback(function (attendeeId) {
...
var useDataFromDataSync = function (participantId) {
    var attendee = userHook_1.useAttendee().attendee;
    var getMuteState = muteStateHook_1.useMuteState().getMuteState;
    ...
    return {
        setHandRaisedDefault: setHandRaisedDefault,
        muteMikeDefault: muteMikeDefault,
        enableMikeDefault: enableMikeDefault,
        requestSpeakerAccessButtonEnabledDefault: requestSpeakerAccessButtonEnabledDefault
    };
};
var CallPad = function (_a) {
    ...
    var _b = userHook_1.useAttendee(),
        attendee = _b.attendee,
        onCallDisconnectCallback = _b.onCallDisconnectCallback,
        mode = _b.mode;
    var _c = useDataFromDataSync(participantId),
        setHandRaisedDefault = _c.setHandRaisedDefault,
        muteMikeDefault = _c.muteMikeDefault,
        enableMikeDefault = _c.enableMikeDefault,
        requestSpeakerAccessButtonEnabledDefault = _c.requestSpeakerAccessButtonEnabledDefault;
    var classes = useStylesFromThemeFunction(props);
    var _d = react_1.useState(setHandRaisedDefault),
        isHandRaised = _d[0],
        setHandRaised = _d[1];
    var _e = react_1.useState(muteMikeDefault),
        isMikeMute = _e[0],
        muteMike = _e[1];
    var _f = react_1.useState(enableMikeDefault),
        isMikeEnabled = _f[0],
        enableMike = _f[1];
    var _g = react_1.useState(requestSpeakerAccessButtonEnabledDefault),
        requestSpeakerAccessButtonEnabled = _g[0],
        enableRequestSpeakerAccessButton = _g[1];
