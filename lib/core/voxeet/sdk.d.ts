...
export declare const purgeVoxeetConference: (onDestroy?: Function) => Promise<void>;
...
export declare const addEventlistenersForCommanding: () => void;
export declare const getVoxeetSessionParticipantId: () => string;
export declare const getVoxeetSessionParticipants: () => Participant[];
