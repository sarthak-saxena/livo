...
var initializeVoxeet = function (config, creator, room) {
    return __awaiter(void 0, void 0, void 0, function () {
        var participant, currentConference, conference, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    currentConference = voxeet_web_sdk_1.default.conference.current;
                    if (!currentConference) return [3, 3];
                    if (!(currentConference.alias !== room.id)) return [3, 3];
                    return [4, exports.purgeVoxeetConference()];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
                    if (!!participant) return [3, 6];
